...
<body>
	...
	<nav>
		<ul class="cd-primary-nav">
            ...
            <li class="cd-label">Conocimiento</li>
			<li><a href="#0">Especialidades</a></li>
			<li><a href="#0">Matematicas</a></li>

			<li class="cd-label">Acerca</li>

			<li><a href="#0">Objetivos</a></li>
			<li><a href="#0">Equipo</a></li>
			<li><a href="#0">Creditos</a></li>
